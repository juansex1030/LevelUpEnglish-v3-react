...
*   **Duración:** Treinta (30) días calendario a partir del momento de la activación del pago.
*   **Naturaleza:** El acceso es temporal y requiere renovación manual o automática según se especifique en la pasarela de pagos.

## 3. PASARELA DE PAGOS Y SEGURIDAD
Los pagos se procesan a través de **ePayco**, una pasarela certificada que garantiza la seguridad de sus transacciones. LevelUpEnglish no almacena directamente números de tarjetas de crédito o credenciales de cuentas bancarias.

## 4. DERECHO DE RETRACTO (Ley 1480 de 2011, Art. 47)
...
- Los datos recolectados (Nombre, Correo) tienen como única finalidad la gestión de la cuenta y el envío de información relevante del curso.
- El usuario puede solicitar la actualización, rectificación o eliminación de sus datos en cualquier momento.

## 7. PROPIEDAD INTELECTUAL
Todo el contenido, juegos, algoritmos y diseño de LevelUpEnglish son propiedad exclusiva de la plataforma. Queda prohibida la reproducción, distribución o ingeniería inversa del software sin autorización previa.

## 8. CONTACTO Y SOPORTE
Para peticiones, quejas, reclamos o sugerencias (PQRS), puede contactarnos a través de:
- **Correo electrónico:** lvupenglishco@gmail.com
- **Módulo de Soporte:** Disponible en la plataforma.

---

*Al realizar el pago de $9.990 COP, usted declara que ha leído, comprendido y aceptado la totalidad de estas cláusulas.*
